    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-foreground-secondary">
              Real-time vulnerability detection overview
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <StatCard
            label="Total Completed Campaigns"
            value="142"
            icon={CheckCircle}
            trend={{ value: 12, direction: "up" }}
          />
          <StatCard
            label="InProgress Campaigns"
            value="3"
            icon={Activity}
        ...
        <div className="stat-card">
          ...
          <div className="space-y-3">
            {[
              {
                name: "openssl-heap-analysis",
                status: "critical",
                progress: 78,
              },
              {
                name: "libpng-format-fuzzing",
                status: "warning",
                progress: 45,
              },
              ...
              <div
                key={scan.name}
                className="p-4 rounded-lg bg-background-secondary border border-border hover:border-primary/50 transition-colors"
              >
